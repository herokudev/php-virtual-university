    ...
    <main class="flex h-screen">
        ...
        <div>
            ...
            <div class=" bg-gray-200 h-screen w-screen">
                <h1 class=" p-3 text-2xl ml-2">Lista de Clases</h1>
                <div class="p-3 bg-white ml-5 w-[80%]">
                    <div class="flex items-center justify-between">
                        <p>Informacion de Clases</p>
                        <a href='clasesAgregar.php'><button class="bg-[#2995c6] text-white w-[150px] pt-2 pb-2">Agregar Clase</button></a>
                    </div> 
                        ...
                        <?php
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        . "<td>" . $row['inscritos'] . "</td>" 
                                        . "<td><div class='flex gap-2'><p><a href='clasesEditar.php?editarId=$id'><img class='h-5 w-auto pr-3' src='../assets/edit_square.svg' alt='edit-icon'></a></p><p><a href='clasesBorrar.php?borrarId=$id'><img class='h-5 w-auto ml-3 pr-3' src='../assets/delete_icon.svg' alt='delete-icon'></a></p></div></td>"                                        
                                        . "</tr>";
                                        $line++;
                                    }
                                }
