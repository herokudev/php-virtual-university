    ...
    <main class="flex h-screen">
        ...
        <div>
            ...
            <div class=" bg-gray-200 h-screen w-screen">
                <h1 class=" p-3 text-2xl ml-2">Lista de Permisos</h1>
                <div class="p-3 bg-white ml-5 w-[80%]">
                    ...
                    <table class="w-full border-collapse border border-slate-500 mt-5">
                        ...
                        <?php
                                ...
                                $sql = "SELECT u.id_usuario, u.email, r.nombre_rol, u.estado from usuarios u, roles r where u.id_rol = r.id_rol;";
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        . "<td>" . $row['estado'] . "</td>" 
                                        . "<td><div class='flex gap-2'><p><a href='permisosEditar.php?editarId=$id'><img class='h-5 w-auto pr-3' src='../assets/edit_square.svg' alt='edit-icon'></a></p></div></td>"                                        
                                        . "</tr>";
                                        $line++;
                                    }
                                }
